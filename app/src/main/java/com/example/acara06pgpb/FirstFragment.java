package com.example.acara06pgpb;
...
import com.example.acara06pgpb.databinding.ActivityMainBinding;
        ...
        Regis.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (checkBox.isChecked()) {
                    ...
                    Toast.makeText(getActivity(), "Harap centang kotak persetujuan!", Toast.LENGTH_SHORT). show();
                }
